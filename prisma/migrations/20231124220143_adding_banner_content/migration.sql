...
CREATE TABLE "new_ShopCountryView" (
    ...
    "bannerContent" TEXT NOT NULL DEFAULT 'none',
...
INSERT INTO "new_ShopCountryView" ("acceptanceCount", "country", "createdAt", "id", "shopId", "viewCount") SELECT "acceptanceCount", "country", "createdAt", "id", "shopId", "viewCount" FROM "ShopCountryView";
