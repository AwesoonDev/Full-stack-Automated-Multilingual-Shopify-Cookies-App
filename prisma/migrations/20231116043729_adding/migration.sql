/*
  ...
  - You are about to alter the column `acceptanceCount` on the `ShopCountryView` table. The data in that column could be lost. The data in that column will be cast from `Boolean` to `Int`.
